  ...
  return (
    <main>
      <div className="p-6">
        ...
        <p className="mb-4">Last updated: October 06, 2024</p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-600 underline">
        ...
        <ul className="list-disc ml-8 mb-4">
          ...
          <li className="mb-2">
            ...
            &quot;Our&quot; in this Agreement) refers to YourKB.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to YourKB, accessible from{" "}
            <a
              href="https://yourkb.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
              className="text-blue-600 underline"
            >
              https://yourkb.vercel.app
            </a>
          </li>
          <li className="mb-2">
        ...
        <p className="mb-4">
          ...
          <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" className="text-blue-600 underline">
            TermsFeed website
          </a>
          .
        </p>
        ...
        <ul className="list-disc ml-8 mb-4">
          <li className="mb-2">By email: ezou626@gmail.com</li>
        </ul>
      </div>
    </main>
  );
