  ...
  return (
    <div className="fixed bottom-0 w-full text-center p-10 z-1000 bg-background border border-border max-w-5xl">
      <p className="pb-5">
        ...
        site, you agree to our use of necessary cookies for authentication and
        authorization. You may also choose to accept or deny other non-essential
        cookies. See{" "}
        <u>
          <Link href="/policies/privacy">our privacy policy</Link>
        </u>{" "}
        for more details.
      </p>
